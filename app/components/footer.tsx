      ...
      <div className="flex items-center space-x-2 mx-auto">
        <h4>
          ...
          <a
            ...
            target="_blank"
            className="text-blue-400 transition-opacity hover:opacity-85"
          >
            felipetodev
          </a>
        </h4>
        <a href="https://github.com/felipetodev/log.js" rel="noopener noreferrer" target="_blank" className="transition-opacity hover:opacity-85">
