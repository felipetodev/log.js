  ...
  return (
    ...
    >
      ...
      <div className="flex items-center space-x-2 mx-auto">
        <a href="https://github.com/felipetodev/log.js" rel="noopener noreferrer" target="_blank" className="inline-flex items-center space-x-1 transition-opacity hover:opacity-85" aria-label="GitHub repository">
          <h4>
            crafted by{' '}
